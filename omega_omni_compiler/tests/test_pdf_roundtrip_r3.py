...
class OmniR3PDFRoundTripTests(unittest.TestCase):
    ...
    def test_selected_semantic_invariants_survived_readback(self):
        self.assertTrue(self.receipt["semantic_roundtrip_pass"])
        self.assertTrue(all(self.receipt["readback_checks"].values()))
